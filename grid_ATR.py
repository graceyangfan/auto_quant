...
class Strategy():
    def __init__(self, args):
        ...
        self.ATR_channel_ratio =args.ATR_channel_ratio
    ...
    def refresh_data(self, period):
        ...
        ##refresh price_gap with ATR
        self.price_gap = self.ATR_channel_ratio*self.ATR()/self.grid_number
    ...
    def deal_over_orders(self):
        if len(self.buy_orders) + len(self.sell_orders) < 1:
            ...
            if price_percent < 0.5:
                trade_price = round(self.quantcenter.Bids_Price1 - self.price_gap, self.price_N)
                ...
                trade_price = round(self.quantcenter.Asks_Price1  + self.price_gap, self.price_N)
        ...
        ## update grid 
        Delta_price = (high_price - low_price) / self.grid_number
        self.full_orders = []
